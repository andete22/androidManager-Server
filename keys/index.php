...
<body onload="javascript:horaDispositivos()">
	...
	<nav class="nav-extended indigo">
		<div class="nav-wrapper">
			...
			<ul id="slide-out" class="side-nav">
				...
				<li class="active"><a href="../keys/index.php?id=<?php echo $_SESSION['dispId']?>">Teclado</a></li>
		...
		<ul class="row hide-on-med-and-down">
			...
			<li class="active col"><a href="../keys/index.php?id=<?php echo $_SESSION['dispId']?>" >Teclado</a></li>
	...
	<main class="center">
		...
		<div class="row">Con esta funci&oacute;n puedes escribir texto en el dispositivo m&oacute;vil, para ello tiene que activar el teclado virtual de AndroManager.</div>
		<div class="row">
			<div class="col offset-m4 m4 s12"><input placeholder="Introduce texto aqu&iacute;" type="text" id="texto_enviar" name="texto" ></div>
		</div>
		<div class="row"><a href="#!" class="btn" onclick="javascript:escribirTexto()">Enviar</a></div>
