...
<body onload="javascript:horaDispositivos()">
	...
	<nav class="nav-extended indigo">
		<div class="nav-wrapper">
			...
			<ul id="slide-out" class="side-nav">
				...
				<li class="active"><a href="../shell/index.php?id=<?php echo $_SESSION['dispId']?>">Shell</a></li>
		...
		<ul class="row hide-on-med-and-down">
			...
			<li class="active col"><a href="../sell/index.php?id=<?php echo $_SESSION['dispId']?>" >Shell</a></li>
	...
	<main class="center">
		<div id="shell" class="col s12">
		<div class="row">Podemos enviar comandos directamente al dispositivo.</div>
		<div class="row">
			<a href="commandos.php" target="_blank" class="btn"><i class="material-icons">help</i> Comandos soportados</a>
		</div>

		<div class="row">
			<div class="col offset-m4 m4 s12"><input placeholder="Introduce texto aqu&iacute;" type="text" id="texto_enviar" name="texto" ></div>
		</div>
		<div class="row"><a href="#!" class="btn" onclick="javascript:enviarCmd()">Enviar</a></div>
