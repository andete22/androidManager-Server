...
<body onload="javascript:run()">
	...
	<nav class="nav-extended indigo">
		<div class="nav-wrapper">
			...
			<ul id="slide-out" class="side-nav">
				...
				<li class="active"><a href="../screen/index.php?id=<?php echo $_SESSION['dispId']?>">Screen Mirroring</a></li>
				<li><a href="../apps/index.php?id=<?php echo $_SESSION['dispId']?>">Aplicaciones</a></li>
		...
		<ul class="row hide-on-med-and-down">
			...
			<li class="active col"><a href="../screen/index.php?id=<?php echo $_SESSION['dispId']?>" >Screen Mirroring</a></li>
			<li class="col"><a href="../apps/index.php?id=<?php echo $_SESSION['dispId']?>" >Aplicaciones</a></li>
	...
	<main class="center">
	<div class="row">Podemos ver en tiempo real la pantalla del dispositivo. Por motivos de seguridad no podemos hacer touch sobre el dispositivo, pero si indicarle al usuario del mismo donde tiene que presionar. Tambi&eacute;n puede poner texto en el cuadro inferior para comunicar mejor las instrucciones (este texto sonar&aacute; en el dispositivo).</div>
		<div class="row">
			<div class="col offset-m4 m4 s12">
				<input placeholder="Texto que sonar&aacute; cuando haga click en la pantalla." type="text" id="mensajePantalla" name="mensaje">
			</div>
		</div>
		<div class="row">
			<div id="screen" class="hoverable" onmousedown="javascript:coordenadasScreen(event)">
			</div>
		</div>
		<div class="row">
			Con este bot&oacute;n puede minimizar la aplicaci&oacute;n de AndroManager.
		</div>
		<div class="row">
			<a href="#!" onclick="pulsoMenu()" class="btn">Minimizar AndroManager</a>
		</div>
